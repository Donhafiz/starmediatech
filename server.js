...
// 🚦 ROUTES
// ===============================
// Serve frontend static assets (so visiting / loads your `frontend/index.html`)
app.use(express.static(path.join(__dirname, 'frontend')));

// SPA fallback: serve index.html for non-API routes that aren't static files
...
try {
  ...
  const consultationRoutes = require('./backend/routes/consultationRoutes');
  ...
  console.warn('Warning: could not mount backend routes:', e.message);
}
app.get('/api', (req, res) => {
